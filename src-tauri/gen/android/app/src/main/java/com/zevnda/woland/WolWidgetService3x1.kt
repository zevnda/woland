...
class WolWidgetService3x1 : RemoteViewsService() {
    override fun onGetViewFactory(intent: Intent) = WolRemoteViewsFactory3x1(applicationContext)
}

class WolRemoteViewsFactory3x1(private val context: Context) : RemoteViewsService.RemoteViewsFactory {
    ...
    override fun getCount() = minOf(devices.size, 2)
    ...
    override fun getViewAt(position: Int): RemoteViews {
        ...
        val rv = RemoteViews(context.packageName, R.layout.widget_device_cell_3x1)
